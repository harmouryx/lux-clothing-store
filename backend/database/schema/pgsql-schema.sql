...
\restrict Md1aY6CpDGTasHEfb6aqLZQaA5btEKX3Qt5l79IbxkRPeMqSCmb0CYpNjxp39gK
...
CREATE TABLE public.products (
    ...
    tax_applied_id bigint NOT NULL,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    image_url text
);
...
CREATE TABLE public.stocks (
    id bigint NOT NULL,
    product_id_variant bigint NOT NULL,
...
--
-- Name: idx_product_attributes; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_product_attributes ON public.product_variants USING gin (attributes);
...
--
-- Name: order_details order_details_order_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: order_details order_details_product_variant_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_details
    ADD CONSTRAINT order_details_product_variant_id_foreign FOREIGN KEY (product_variant_id) REFERENCES public.product_variants(id);
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_payment_method_id_foreign FOREIGN KEY (payment_method_id) REFERENCES public.payment_methods(id);
...
--
-- Name: product_variants product_variants_fk_product_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_variants
    ADD CONSTRAINT product_variants_fk_product_id_foreign FOREIGN KEY (fk_product_id) REFERENCES public.products(id);


--
-- Name: products products_tax_applied_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_tax_applied_id_foreign FOREIGN KEY (tax_applied_id) REFERENCES public.taxes(id) ON DELETE CASCADE;
...
--
-- Name: stocks stocks_product_id_variant_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.stocks
    ADD CONSTRAINT stocks_product_id_variant_foreign FOREIGN KEY (product_id_variant) REFERENCES public.product_variants(id) ON DELETE CASCADE;
...
\unrestrict Md1aY6CpDGTasHEfb6aqLZQaA5btEKX3Qt5l79IbxkRPeMqSCmb0CYpNjxp39gK

--
-- PostgreSQL database dump
--

\restrict 9bK4HKDG9SpSKRN5eocnWzRWSYT4sLMNWHas7Qtx4Ow6Q033cZU7shD5E8X8N1q
...
4	2026_07_28_001032_create_personal_access_tokens_table	1
5	2026_08_03_154721_create_permission_tables	1
6	2026_08_05_171801_add_two_factor_columns_to_users_table	1
7	2026_08_05_171802_create_passkeys_table	1
8	2026_08_06_140503_update_users_table	1
9	2026_08_17_034802_create_taxes_table	1
10	2026_08_17_172406_create_products_table_v2	1
11	2026_08_18_153221_update_taxes_table	1
12	2026_08_19_013242_update_taxes_table	1
13	2026_08_30_221641_update_users_table	2
14	2026_08_30_223104_fix_update_users_table	3
15	2026_08_30_224036_fix_re_update_users_table	4
16	2026_08_19_021311_create_product_variants_table	5
17	2026_08_19_020622_create_stocks_table	6
18	2026_08_19_140129_update_product_variants	7
19	2026_08_21_163327_update_stocks_table	8
20	2026_08_26_164910_create_payment_methods_table	9
21	2026_08_26_171030_create_orders_table	10
22	2026_08_27_030433_create_order_details_table	11
23	2026_08_19_143723_update_product_table	12
24	2026_08_30_233000_add_image_url_to_products_and_variants_tables	13
\.
...
\unrestrict 9bK4HKDG9SpSKRN5eocnWzRWSYT4sLMNWHas7Qtx4Ow6Q033cZU7shD5E8X8N1q
